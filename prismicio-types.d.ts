...
/**
 * Item in *AlternatingText → AlternatingText → Primary → Text Group*
 */
export interface AlternatingTextSliceDefaultPrimaryTextGroupItem {
  /**
   * Heading field in *AlternatingText → AlternatingText → Primary → Text Group*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
  ...
  /**
   * Body field in *AlternatingText → AlternatingText → Primary → Text Group*
   *
...
/**
 * Primary content in *AlternatingText → AlternatingText → Primary*
 */
export interface AlternatingTextSliceDefaultPrimary {
  /**
   * Text Group field in *AlternatingText → AlternatingText → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
...
/**
 * AlternatingText variation for AlternatingText Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
...
/**
 * BigText variation for BigText Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
...
/**
 * Primary content in *Carousel → Carousel → Primary*
 */
export interface CarouselSliceDefaultPrimary {
  /**
   * Heading field in *Carousel → Carousel → Primary*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
  ...
  /**
   * Price Copy field in *Carousel → Carousel → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
...
/**
 * Carousel variation for Carousel Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
...
export interface HeroSliceDefaultPrimary {
  /**
   * Heading field in *Hero → Hero → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
  ...
  /**
   * Subheading field in *Hero → Hero → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
  ...
  /**
   * Body field in *Hero → Hero → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
  ...
  /**
   * Button Text field in *Hero → Hero → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
  ...
  /**
   * Cans Image field in *Hero → Hero → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
  ...
  /**
   * Second Heading field in *Hero → Hero → Primary*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
  ...
  /**
   * Second Body field in *Hero → Hero → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
...
/**
 * Primary content in *SkyDive → SkyDive → Primary*
 */
export interface SkyDiveSliceDefaultPrimary {
  /**
   * Sentence field in *SkyDive → SkyDive → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
  ...
  /**
   * Flavor field in *SkyDive → SkyDive → Primary*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
...
/**
 * SkyDive variation for SkyDive Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
